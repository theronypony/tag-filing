...
import { getNotebookNavigatorApi, moveFileWithNotebookNavigator, selectNotebookNavigatorTag } from './nnApi';
...
export default class TagFilingPlugin extends Plugin {
    ...
    async onload(): Promise<void> {
        ...
        this.tagDropFiler = new TagDropFiler(this.app, this.folderMover, {
            ...
            renameFile: (file, destination) => moveFileWithNotebookNavigator(this.app, file, destination),
